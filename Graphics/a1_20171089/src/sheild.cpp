...
Sheild::Sheild(float x, float y) {
    ...
    this->display = true;
    this->box = {42,10,1,1};
    this->object = create3DObject(GL_TRIANGLES, 2*3, vertex_buffer_data, COLOR_SILVER, GL_FILL);
}

void Sheild::draw(glm::mat4 VP) {
...
void Sheild::set_position(float x, float y) {
